...
const (
    Rootinfo string = `{"apiVersion":"1.0.0","swaggerVersion":"1.2","apis":[{"path":"/users","description":"Operations about user\n"}],"info":{"title":"beego+postgresql test API","description":"beego has a very cool tools to autogenerate documents for your API","contact":"1679550318@qq.com","termsOfServiceUrl":"https://github.com/leonardyp","license":"Url http://www.apache.org/licenses/LICENSE-2.0.html"}}`
